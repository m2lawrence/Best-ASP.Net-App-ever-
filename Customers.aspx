...
&nbsp;<asp:TextBox ID="txtSelectMobile" runat="server" ForeColor="Maroon" MaxLength="11" ReadOnly="True"></asp:TextBox>
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceCustomers" AllowSorting="True" DataKeyNames="Cust_ID" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="1022px">
        ...
        <asp:SqlDataSource ID="SqlDataSourceCustomers" runat="server" ConnectionString="<%$ ConnectionStrings:mikeConnectionStringCust %>" SelectCommand="SELECT * FROM [Customer] ORDER BY [Cust_ID]"></asp:SqlDataSource>
        <br />
...
&nbsp;<br />
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceCustomers" AllowSorting="True" DataKeyNames="Cust_ID" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="1022px">
            <AlternatingRowStyle BackColor="PaleGoldenrod" />
            <Columns>
                <asp:BoundField DataField="Cust_ID" HeaderText="Cust_ID" ReadOnly="True" SortExpression="Cust_ID" />
                <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
        ...
        <asp:DropDownList ID="DDLDeleteCust_ID" runat="server" ForeColor="Maroon">
            <asp:ListItem>1</asp:ListItem>
            <asp:ListItem>2</asp:ListItem>
            <asp:ListItem>3</asp:ListItem>
            <asp:ListItem>4</asp:ListItem>
        ...
        <br />
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceCustomers" AllowSorting="True" DataKeyNames="Cust_ID" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="1022px">
            <AlternatingRowStyle BackColor="PaleGoldenrod" />
            <Columns>
                <asp:BoundField DataField="Cust_ID" HeaderText="Cust_ID" ReadOnly="True" SortExpression="Cust_ID" />
                <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
